#!/usr/bin/env bash
# ATB BI Warehouse - Master Deployment Runbook
# Complete end-to-end deployment guide for Phases 1-3
# ===================================================
...
# Step 4: Run Deployment Validator
echo ""
...
export AIRFLOW_HOME=./2_orchestration
airflow db init
...
airflow variables set DBT_PROJECT_DIR "$(pwd)/3_transformation"
...
echo "  export AIRFLOW_HOME=$(pwd)/2_orchestration"
